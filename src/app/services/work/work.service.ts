...
export class WorkService {
  ...
  readonly TLP_DATE = "Apr '23 - Sept '23 and Apr '25 - Present";

  readonly TLP_CARD: WorkCard = { Employer: this.TLP_EMPLOYER, JobTitle: this.TLP_JOB_TITLE, Points: this.TLP_POINTS, Date: this.TLP_DATE }
